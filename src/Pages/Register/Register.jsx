...
const Register = () => {
    ...
    return (
        <div>
            ...
            <div class="h-screen p-8 my-2 md:flex">
                <div
                ...
                <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
                    <form onSubmit={handleRegister} class="bg-white">
                        ...
                        <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                            ...
                            <input class="pl-2 outline-none border-none" type="text" name="name" id="" placeholder="Username" required />
                        ...
                        <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                            ...
                            <input class="pl-2 outline-none border-none"   id="" placeholder="Email Address"  type="email" name='email' required />
                        </div>
                            <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                            ...
                            <input class="pl-2 outline-none border-none" type="text" id="" placeholder="Photo URL" name='photourl' required />
                        </div>
