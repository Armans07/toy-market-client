    ...
    return (
        <div className="flex flex-col md:flex-row max-w-6xl mx-auto my-8 items-center gap-16">
            ...
            <form onSubmit={handleSubmit} className="flex-1 bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl text-blue-900 font-bold text-center mb-4">Contact Us</h2>
                <div className="mb-4">
                ...
                <button type="submit" className="bg-blue-950 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Send Message</button>
            </form>
            <div className="flex-shrink-0 md:mr-4 text-center">
                <h3 className="text-3xl font-extrabold text-blue-900 mb-2 ">Contact Information</h3>
